...
export default function VideoCard({ video, watchHistory }: VideoCardProps) {
    ...
    return (
        <Link href={`/knowledge-hub/${video.id}`} className="group flex flex-col bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
