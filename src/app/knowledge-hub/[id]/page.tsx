    ...
    if (!video) {
        return (
            <div className="min-h-screen bg-slate-50 pt-24 px-4 flex flex-col items-center">
                ...
                <button onClick={() => router.push('/knowledge-hub')} className="text-emerald-600 hover:underline">
    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-24 pb-12 px-4 md:px-8">
            <div className="max-w-6xl mx-auto">
                <Link href="/knowledge-hub" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-slate-900 transition-colors mb-6">
